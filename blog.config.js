...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 300, // Public content stays static for 5 minutes before the next request may trigger ISR regeneration.
  ...
  ...require('./conf/knowledge-graph.config'), // 知识图谱配置
