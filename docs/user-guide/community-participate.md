...
| 主题风格建议 | 使用 [主题风格建议模板](https://github.com/notionnext-org/NotionNext/discussions/new/choose)，附参考站点、截图和适用场景 |
...
**改代码 / 主题**：阅读 [开发文档](../developer/) · [贡献指南](https://github.com/notionnext-org/NotionNext/blob/main/CONTRIBUTING.zh-CN.md) · 大改动先写 [RFC](../developer/rfc/)

**用 AI 参与主题开发**：先看 [借助 AI 开发 NotionNext](./development/notion-next-develop-with-ai.md) 与 [AI 主题开发提示词包](./development/ai-theme-prompts.md)。如果只是想提风格方向，可参考仓库中的 [主题共创长期活动](../community/THEME_CHALLENGE.zh-CN.md)、[主题生态长期运营模型](../community/THEME_ECOSYSTEM_OPERATING_MODEL.zh-CN.md) 与 [主题新手任务池](../community/GOOD_FIRST_THEME_TASKS.zh-CN.md)。
...
- 单主题说明或截图更新
- 翻译与 `lib/lang` 补充
- 主题风格参考清单、主题预览图、主题简介、AI 主题开发案例

维护者会在 [Discussions](https://github.com/notionnext-org/NotionNext/discussions) 置顶「欢迎贡献」帖；草稿见 [PINNED_DISCUSSION_POSTS.zh-CN.md](../community/PINNED_DISCUSSION_POSTS.zh-CN.md)。主题活动可直接使用 [主题共创长期活动](../community/THEME_CHALLENGE.zh-CN.md)、[主题生态长期运营模型](../community/THEME_ECOSYSTEM_OPERATING_MODEL.zh-CN.md) 与 [主题新手任务池](../community/GOOD_FIRST_THEME_TASKS.zh-CN.md)。
