...
> **历史提案，当前不实施。** 2026-07-13 起，仓库已移除内置 Clerk 演示、登录注册页面和演示 Dashboard。现有评论系统继续使用各评论服务自己的身份机制。未来若重新引入会员系统，需要重新完成产品设计、平台评估和安全审查。

本文保留的是当时关于“登录、会员、权限、评论”方向的方案草案，不是当前功能或承诺清单。当时的目标是把 Clerk 演示、Notion Integration 能力和评论插件体系收口成可维护、可替换、可自托管的可选方案。
