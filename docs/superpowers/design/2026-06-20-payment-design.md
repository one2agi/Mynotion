...
**Database ID**：`4044f4cfc8e28236a41e818304648b77`（"模板客户管理"）
```
...
├─────────────────────┼──────────────────┼────────────────────────────┤
│ Token               │ rich_text       │ Z-Pay 平台订单号（运营手动填）│
├─────────────────────┼──────────────────┼────────────────────────────┤
│ 源链接              │ url              │ 支付来源 URL（运营手动填）   │
├─────────────────────┼──────────────────┼────────────────────────────┤
│ 备注                │ rich_text       │ 备注（运营手动填）           │
├─────────────────────┼──────────────────┼────────────────────────────┤
│ 交付时间            │ date             │ 实际交付时间（运营手动填）    │
├─────────────────────┼──────────────────┼────────────────────────────┤
│ 发送唯一链接        │ formula          │ Notion 自动计算              │
├─────────────────────┼──────────────────┼────────────────────────────┤
│ 交付产品369         │ button           │ 交付按钮                    │
└─────────────────────┴──────────────────┴────────────────────────────┘
```

> **代码自动写入**：创建时间、订单号、电子邮箱、姓名、商品名称、价格(元)、优惠码、付款时间、状态
> **运营手动填**：Token、源链接、备注、交付时间
...
NOTION_DATABASE_ID=4044f4cfc8e28236a41e818304648b77
